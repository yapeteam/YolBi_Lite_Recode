...
public class MoveFix extends Module {
    ...
    public void runStrafeFixLoop(boolean isSilent, EventStrafe event) {
        ...
        int angleDiff = (int) ((RotationManager.wrapAngleTo180_float(mc.player.rotationYaw - yaw - 22.5f - 135.0f) + 180.0) / 45.0);
        ...
        float calcMultiplier = MathHelper.sqrt(calcMoveDir / Math.min(1.0f, calcMoveDir * 2.0f));
    ...
    public void applyStrafeToPlayer(EventStrafe event) {
        ...
        int dif = (int) ((RotationManager.wrapAngleTo180_float(player.rotationYaw - yaw - 23.5f - 135) + 180) / 45);
