...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Map map : vanilla) {
            switch (map.getType()) {
                case Class:
                    sb.append("CL: ").append(map.name).append(' ').append(map.obf).append('\n');
                    break;
                case Field:
                    sb.append("FD: ").append(map.owner).append('/').append(map.name).append(' ').append(map.obf_owner).append('/').append(map.obf).append('\n');
                    break;
                case Method:
                    sb.append("MD: ").append(map.owner).append('/').append(map.name).append(' ').append(map.desc).append(' ').append(map.obf_owner).append('/').append(map.obf).append(' ').append(map.obf_desc).append('\n');
                    break;
            }
        }
